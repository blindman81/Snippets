...
@Composable
fun DateHeadersScreen(viewModel: SnippetsViewModel) {
    ...
    val headerColor by animateColorAsState(
        ...
        label = "date_headers_top_bar_color"
    )
    ...
    Scaffold(
        ...
        Surface(
            ...
            Column(
                ...
                // Favorites
                val isFavoritesSelected = viewModel.showDateHeadersIn.contains("Favorites")
                DynamicCardContainer(
                    onClick = { 
                        view.performHapticFeedback(HapticFeedbackConstants.CONFIRM)
                        viewModel.toggleDateHeaderVisibility("Favorites")
                    },
                ...
                collections.forEachIndexed { index, collectionName ->
                    val isSelected = viewModel.showDateHeadersIn.contains(collectionName)
                    DynamicCardContainer(
                        onClick = { 
                            view.performHapticFeedback(HapticFeedbackConstants.CONFIRM)
                            viewModel.toggleDateHeaderVisibility(collectionName)
                        },
